...
public class GenerateRandomConNick {
    ...
    private static List<String> firstWords = Arrays.asList("헤롱헤롱한", "당도높은", "너그러운", "성질급한", "빛갈좋은", "매우상한", "싱싱한", "벌레먹은"
            ...
            , "똑똑한", "배긁는", "안경쓴");
    private static List<String> secondWords = Arrays.asList("메론", "모과", "파파야", "한라봉", "석류", "코코넛", "야자", "두리안", "망고스틴", "슈가애플", "복숭아", "망고", "자두", "체리", "딸기"
            , "곶감", "오렌지", "사과", "자몽", "키위", "파인애플", "망고", "바나나", "라임", "레몬", "아보카도", "수박", "두리안");
